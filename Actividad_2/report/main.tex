...
\author{Juan Nicolás Patiño Rodríguez \\ \small Maestría en Inteligencia Artificial \\ \small Universidad de La Sabana}
\date{\today}
...
\input{sections/02_datos_metodologia}
\input{sections/03_analisis_grafico}
\input{sections/04_descomposicion}
\input{sections/05_modelado_pronostico}
\input{sections/06_resultados_discusion}
